<script lang="ts">
	...
	const description = 'I’d like to retire there and do nothing, or nothing much';
</script>
...
<section>
	<figure>
		<a href="https://collections.stormking.org/Detail/objects/416">
			<img src={wavefield} alt="Grassy hills in the shape of waves, trees in the background." />
		</a>
	...
	<p>
		...
		I’d like to retire there and do nothing,<br />
		or
		<a href="https://www.tumblr.com/poem-today/613853909046444032/a-poem-by-elizabeth-bishop"
			>nothing much</a
		>, forever, in two bare rooms:<br />
	...
	<aside>
		<p>
			Now it is imperative that I <a
				href="https://www.google.com/books/edition/A_Man_s_Place/6HD8If3kJuYC?hl=en&gbpv=1&pg=PA61&printsec=frontcover"
				>unravel these memories</a
			>, all the more so since I have long suppressed them, believing them to be of no consequence.
			If they have survived, it is through sheer humiliation. I surrendered to the will of the world
			in which I live, where memories of a lowly existence are seen as a sign of bad taste.
		</p>
	</aside>
