...
<Section>
  ...
  <p>
    One idea <a
      href="https://www.poetryfoundation.org/poems/57327/one-train-may-hide-another"
      >may hide another</a
    >: Life is simple<br />
  ...
  <aside>
    Frequently, the organization of the system reflects the sprawl and history
    of the organization that built it (as per CONWAY’S LAW [<a
      href="http://laputan.org/pub/papers/processpatterns.pdf"
      title="A Development Process Generative Pattern Language">Coplien 1995</a
    >]) and the
    <a href="http://www.laputan.org/mud/mud.html"
      >compromises that were made along the way</a
    >. Renegotiating these relationships is often difficult once the basic
    boundaries among system elements are drawn. These relationships can take on
    the immutable character of “site” boundaries that Brand [<a
      href="https://openlibrary.org/works/OL823146W/How_Buildings_Learn"
      title="How Building Learn (OpenLibrary)">Brand 1994</a
